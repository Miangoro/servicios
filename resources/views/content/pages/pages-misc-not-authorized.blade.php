...
@section('content')
    ...
    <div class="misc-wrapper">
        <div class="content-wrapper">
            ...
            <h1 class="mb-2 mx-2 text-center glow" style="font-size: 6rem;line-height: 6rem;">ERROR 401</h1>
            <h4 class="mb-2 text-center">Usted no esta utorizado! 🔐</h4>
            <p class="mb-3 mx-2 text-center">Usted no tiene permitido acceder a esta página. Regrese al inicio!</p>
            <div class="d-flex justify-content-center">
                ...
                <div class="d-flex flex-column align-items-center">
                    <img src="{{ asset('assets/img/illustrations/logo_error.png') }}" alt="misc-error" class="img-fluid z-1"
                        width="500">
                    <div>

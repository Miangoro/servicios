        ...
        <div class="col">
            <div class="card shadow">
                ...
                <div class="table-responsive p-3">
                    <table id="tablaPersonalReglar" class="table table-flush table-bordered personalR_datatable table-striped table-sm">
                        <thead class="table-dark">
                            <tr>
                                <th scope="col" class="text-white">#</th>
                                <th scope="col" class="text-white">Folio de empleado</th>

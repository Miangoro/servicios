    ...
    <div class="modal-dialog modal-lz">
        <div class="modal-content">
            ...
            <div class="modal-header bg-primary pb-4">
                <h5 class="modal-title text-white">Reexpedir/Cancelar certificado de venta nacional</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>

            <div class="modal-body">
                <form id="FormReexpedir" method="POST" action="{{ route('reexpedir-cer-nac') }}">
                    <div class="row mb-4">
                ...
                <div id="campos_condicionales" style="display: none;">
                    ...
                    <div class="row mb-4">
                        <div class="col-md-12">
                            <div class="form-floating form-floating-outline">
                            <select class="select2 form-select" id="rex_id_solicitud" name="id_solicitud" 
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-md-6">
                            <div class="form-floating form-floating-outline">
                                <input class="form-control flatpickr-datetime" id="rex_fecha_vigencia"

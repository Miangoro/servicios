        ...
        <div class="modal-content">
            ...
            <div class="modal-body p-4 col-12">
                <form id="agregarProveedorForm" class="row g-5">
                    ...
                    <div class="col-12 col-md-6">
                        <select id="select_Tipo_Compra" class="form-select form-floating form-floating-outline"
                            name="selectTipoCompra">
                    ...
                    <div class="col-12">
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered" id="contactosTable">
                                <thead>
                                    <tr>
                                        <th>Nombre</th>
                                        <th>Teléfono</th>
                                        <th>Email</th>
                                        <th><button type="button" class="btn  btn-primary" id="addContactRow">
